...
//   // Make sure to use debouncedSearchQuery in your filteredProducts logic

//   // The rest of your component code continues here...
...
//       name: k, 
//       count: counts[k], 
//       icon: k.includes('Software') || k.includes('Digital') ? Download : 
//             k.includes('Physical') ? Package : Cog 
//     }))
//   }, [products])
...
// }) {
//   return (
//     <Card className="group overflow-hidden rounded-3xl border-0 bg-white shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer">
...
//             <p className="text-sm opacity-90 mb-2 line-clamp-2">{product.description}</p>
//             <div className="flex items-center justify-between">
