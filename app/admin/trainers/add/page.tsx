...
export default function AddTrainerPage() {
  ...
  const stepContent = [
    ...
    <div key="basic" className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-4">
          <Input id="profileImage" placeholder="Choose user image" readOnly />
    ...
    <div key="qualification" className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Textarea id="certifications" placeholder="Enter certifications" rows={4} />
      </div>
    </div>,
  ...
  return (
    <AdminLayout>
      <MultiStepForm title="Trainer add" steps={steps} onSubmit={() => console.log("Form submitted")}>
        {stepContent}
      </MultiStepForm>
    </AdminLayout>
  )
