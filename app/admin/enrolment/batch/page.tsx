            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select>
                  ...
                  <SelectContent>
                    <SelectItem value="batch1">Web Dev Batch 2024-A</SelectItem>
                    <SelectItem value="batch2">Data Science Batch 2024-A</SelectItem>
                    <SelectItem value="batch3">Digital Marketing Batch 2024-A</SelectItem>
                    <SelectItem value="batch4">Python Programming Batch 2024-B</SelectItem>
                  </SelectContent>
                </Select>
              </div>
